...
<script type="text/javascript">
if (supports_video) {
  document.write('Here <a href="http://www.parasitesatemybrain.com/m/pa/vid/MAM.mp4" target="_blank">this video</a> is supposed to appear:<br /><video src="http://www.parasitesatemybrain.com/m/pa/vid/MAM.mp4" id="myVideo" autoplay="true" height="434" width="770" controls="controls">Video not supported anyway</video>');
}
else {
