...
// hackety hack, weird bug fix
function fixFuckingIssue() {
  $('.q-prob.q-innerArea').css("display","none").css("display","block");
}
...
(function($){	
	var _jQuizMeLayOut = jQuery_1_3_2("<div/>").addClass( "quiz-el").append( 
		...
		jQuery_1_3_2("<div/>").addClass( "q-prob q-innerArea" ).append( 
			...
			jQuery_1_3_2("<div/>").addClass( "q-ans q-probArea").append(
					...
					jQuery_1_3_2( "<input type='button' />" ).addClass( "q-check-btn" )
				),
	...
	jQuery_1_3_2.fn.jQuizMe = function( wordList, options, userLang ){
        ...
        var t = setTimeout("fixFuckingIssue()", 500);
        var t = setTimeout("fixFuckingIssue()", 1000);
        var t = setTimeout("fixFuckingIssue()", 1500);
