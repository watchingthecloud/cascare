...
<html>
	...
	<!--apple meta-->
<title>Emergency Care Bandage</title>
	</head>
	<body>
		<div id="header">
			<img align="left" id="headflag" src="../../images/sprite.png"/>
			<img align="right" id="logo" src="../../images/logo.png"/>
			Emergency Care Bandage
		</div>
		<div id="content">
			<!------------------------------------------------------------------------------------------------->
			<div id="viewlink"><a href="javascript:history.go(-1)" data-direction="reverse" class="button button-blue"><span>Back</span></a>
			<div id="video">
				<video width="650px" src="v9.mp4" controls></video>
			</div>
			<!------------------------------------------------------------------------------------------------->
		</div>		
		<div id="menu" class="menu">
			<ul>
				...
				<a href="../kit-home.html"><li id="kitbutton" class="menubutton" ><img src="../../images/bagicon_sml.png"/></li></a>
